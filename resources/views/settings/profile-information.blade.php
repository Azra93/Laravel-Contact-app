...
@section('title', 'Contact App | Profil Information')
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" value="{{ old('email', $user->email)}}" id="email" class="form-control @error('email') is-ivalid @enderror">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
